...
HttpRequest requestLat("https://group-project-5356f.firebaseio.com/vehicleLocations/id2/GPS/Lat.json");
HttpRequest requestLng("https://group-project-5356f.firebaseio.com/vehicleLocations/id2/GPS/Lng.json");
